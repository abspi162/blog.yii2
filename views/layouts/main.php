    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li style="margin-left: 170px"><?= LangWidget::widget();?></li>
                <div class="i_con">
                    <ul class="nav navbar-nav text-uppercase">
...
<footer class="footer-widget-section">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="address">
                        ...
                        <p> 10 Zarichanska Streets, KHM, UA</p>

                        <p> Phone: +38 098 8186959</p>
                ...
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        ...
                        <div>
                            ...
                            <span class="p-date">October 4, 2019</span>
                        </div>
                    </div>
                </aside>
            </div>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2019 <a href="#"> XPK, </a> Built with <i
                                class="fa fa-heart"></i> by <a href=#https://www.instagram.com/imaginary.snow/">Dmitry Shapovaliuk</a>
                    </div>
                </div>
            </div>
        </div>
